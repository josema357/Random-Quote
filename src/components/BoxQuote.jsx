...
const BoxQuote = (props) => {
  ...
  const newQuoteFunc=()=>{
    ...
    document.documentElement.style.setProperty('--color-page',colors[color]);
  }
  return (
    <>
    <div id='quote-box' className='bg-white text-page font-medium w-[90%] max-w-[550px] flex flex-col justify-center content-center px-[10px] py-[20px] min-[500px]:px-[30px] min-[500px]:py-[20px] gap-[15px] rounded-md'>
        <div id='quote-prub' className={props.initState.quote.data===null ? "quote-text text-center" : (props.initState.quote.isLoading) ? "quote-text text-center opacity-0" : "quote-text text-center opacity-100"}>
